...
SECRET_KEY = 'django-insecure-4ey58q2)mjd$5j4p%5l0#^5xkxgrg(&vyz7uda!9wym+e5^bf4'
...
STATIC_URL = 'static/'
STATICFILES_DIRS = [
    BASE_DIR / 'restaurant' / 'templates' / 'react' / 'static',
...
# Add a logging configuration to handle errors and warnings
LOGGING = {
    'version': 1,
